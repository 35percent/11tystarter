...
Southwark argued that the outline permission was just that - *“very outline”* - for a development that would take a long period of time.  It was not a detailed permission and much remained to be approved under the seperate reserved matters applications for the four phases.  On a legal point, Southwark said that what was built on one phase, such as Phase 2B, would be less likely to create a problem with what was built elswhere on the estate, because each phase was a *'discrete area' \[with] no necessary overlap or conflict'*.  The phased outline permission gave Southwark and NHG *'scope.....to react to whatever has already been developed in earlier phases when considering a subsequent phase'*.  Southwark further argued that *'the key issue is whether an outline permission authorises a number of independent acts of development on spatially discrete areas of land through a phasing arrangement, not whether the word “severable” was used in the consent.'*
