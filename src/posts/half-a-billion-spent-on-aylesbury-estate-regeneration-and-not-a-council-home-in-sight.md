...
Oct 2009	           The Executive approves the joint procurement of development and housing association partners with the Homes and Communities Agency (HCA) for the four Phase 1 sites - Site 1a, a second south west corner site (later known as the FDS), the small Amersham site, in the centre of tehestate and the North Wolverton site (later known as Site 7), at the north east corner of the estate. It also approves the phased re-housing of Phase 1 residents and instructs officers to explore all possible external funding sources, including Social Housing Grant.
