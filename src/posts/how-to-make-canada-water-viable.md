---
title: How to make Canada Water viable
description: Result of viability assessment shows how huge development can be profitable
date: 2026-01-31T12:16:55.952Z
---
A viability assessment of the huge Canada Water regeneration scheme shows how it can be profitable, despite the claim of developer British Land that will lose money and so cannot supply any affordable housing.
...
When the result of viability assessments is so highly contested, and so dependant on marginal differences, it is not sensible to allow them as the determining factor in planning decisions.  This is recognised to a degree by the National Planning Policy Framework (NPPF), which allows the decision-maker discretion in the weight they give FVAs (REF)

We can also say that the idea that a development of 3,700 new homes (and xxx sgm of retail) near the centre of London, cannot make a profit big eough to include affordable housing is inherently unlikely.  elatively little demolition is needed - the a site is dominated by a large car-park (CHECK), and otherwise occupied by 'big-shed' type buildings. 
