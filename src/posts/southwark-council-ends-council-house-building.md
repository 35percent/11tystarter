...
Now that it is abandoning direct delivery, fulfilling that pledge by *‘utilise (-ing) development partners’*[^12] looks like wishful thinking. The building industry’ problems reported to the July cabinet apply to the whole sector. Developers will factor these into viability assessments, along with profit margins set by themselves, to deliver as little affordable and social rented housing as possible.
