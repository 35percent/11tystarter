...
But while the scheme is described by Southwark Council as being ‘on site’, in practice. this is only true of Phase 1 of the four-phase development.    An examination of Southwark’s planning register (CHECK) shows that while all the phases have an outline planning permission, only [Phase 1 has a full detailed planning permission](https://moderngov.southwark.gov.uk/mgAi.aspx?ID=64449).  Phases 2, 3 and 4 do not yet have these vital approvals.  Most of the 690 new homes will be delivered on these later phases (523 homes); Phase 1 will deliver 167 units, including 157 ‘affordable’ homes. 
